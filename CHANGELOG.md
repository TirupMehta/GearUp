...
- Standard project documentation (`README.md`, `CODE_OF_CONDUCT.md`, `CONTRIBUTING.md`, `SECURITY.md`).

### Changed
- Refined dashboard theming entirely with dark mode, electric blue, and neon green accents.

### Fixed
- Addressed basic loading states and initial file parsing errors.

[Unreleased]: https://github.com/TirupMehta/GearUp/commits/main
